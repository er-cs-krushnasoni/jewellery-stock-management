...
function SkeletonBlock({ className = "" }) {
  return (
    <div
      className={`animate-pulse bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 dark:from-gray-700 dark:via-gray-600 dark:to-gray-700 bg-[length:200%_100%] rounded-lg ${className}`}
      style={{
...
function MetalCardSkeleton() {
  return (
    <Card className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-2xl bg-white/80 backdrop-blur-md border-2 border-gray-200/50 dark:bg-gray-800/80 dark:border-gray-700/50 h-full">
      <CardContent className="relative p-4 sm:p-8 space-y-4 sm:space-y-6">
        {/* Title row */}
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3 sm:space-x-4">
            <SkeletonBlock className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl" />
            <SkeletonBlock className="w-20 h-6 sm:w-24 sm:h-7" />
          </div>
          <SkeletonBlock className="w-5 h-5 sm:w-6 sm:h-6 rounded" />
        </div>
        {/* Stats */}
...
function ChartCardSkeleton({ title }) {
  return (
    <Card className="rounded-2xl sm:rounded-3xl shadow-2xl bg-white/80 backdrop-blur-md border-2 border-gray-200/50 dark:bg-gray-800/80 dark:border-gray-700/50">
      <div className="p-4 sm:p-6 pb-3 sm:pb-4 border-b border-gray-100 dark:border-gray-700/50">
        <div className="flex items-center justify-between">
          ...
          <SkeletonBlock className="w-6 h-6 sm:w-8 sm:h-8 rounded-xl" />
        </div>
      </div>
      <CardContent className="p-3 sm:p-6">
        <div className="flex flex-col items-center space-y-4">
          {/* Fake donut */}
          <SkeletonBlock className="w-48 h-48 sm:w-56 sm:h-56 rounded-full" style={{ borderRadius: "50%" }} />
          {/* Legend rows */}
          <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-2 mt-2">
            {[1, 2, 3, 4].map((n) => (
              <div key={n} className="flex items-center justify-between p-2 sm:p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50">
          ...
          {loading ? (
            <>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-8">
                <ChartCardSkeleton title="Gold Category Distribution" />
                <ChartCardSkeleton title="Silver Category Distribution" />
              </div>
            </>
          ) : (
            <>
